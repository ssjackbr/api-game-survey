# API-GAME-SURVEY
[![NPM](https://img.shields.io/npm/l/react)](https://github.com/ssjackbr/api-game-survey/blob/master/LICENSE) 

# Sobre o projeto
 
A api-game-survey é uma aplicação full stack web que consiste em uma pesquisa de preferência de games onde as votações são computadas e atualizadas instantaneamente.
...
```bash
# clonar repositório
git clone https://github.com/ssjackbr/api-game-survey
